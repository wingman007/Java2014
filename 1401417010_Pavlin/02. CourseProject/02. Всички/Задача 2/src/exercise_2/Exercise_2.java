...
public class Exercise_2 {
    ...
    protected static int[] arr1 = populateArray();
    protected static int[] arr2 = populateArray();
    protected static int[] arr3 = populateArray();
    ...
    protected static int[] populateArray() {
        
        int size = randomWithRange(1, 20);

        int[] populateArr = new int[size];
        
        for(int i = 0 ; i < size; i++) {
            
            populateArr[i] = randomWithRange(-100, 100); 
        }
